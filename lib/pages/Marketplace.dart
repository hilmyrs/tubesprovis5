                      ...
                      return Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // Widget CheckboxListTile untuk multiple filter choices
                            // ListTile(
                            //   title: Text('Filter Jenis Usaha'),
                            //   trailing: Wrap(
                            //     children: <Widget>[
                            //       for (String jenisUsaha in jenisUsahaOptions)
                            //         Checkbox(
                            //           value:
                            //               selectedFilters.contains(jenisUsaha),
                            //           onChanged: (bool? value) {
                            //             setState(() {
                            //               if (value != null) {
                            //                 if (value) {
                            //                   selectedFilters.add(jenisUsaha);
                            //                 } else {
                            //                   selectedFilters
                            //                       .remove(jenisUsaha);
                            //                 }
