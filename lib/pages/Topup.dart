...
class Topup extends StatefulWidget {
  ...
  Topup({required this.data, required this.type, required this.data_dompet});
...
class _TopupState extends State<Topup> {
  ...
  Future<void> updateSaldo(int id, int saldo, int jml,
    ...
    if (response.statusCode == 200) {
      ...
      String keterangan = "";
      if (pembayaran == 'Bank') {
        keterangan = "Isi Saldo Melalui Bank";
      } else {
        keterangan = "Isi Saldo Melalui E-Wallet $dompet";
      }
      addTransaction(2, dataUser['data']['id_dompet'], "Isi Saldo", jml,
      ...
      if (widget.type == "investor") {
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Success'),
              content: Text('Top Up Berhasil Dilakukan !'),
              actions: [
                TextButton(
                  onPressed: () {
                    Navigator.push(
